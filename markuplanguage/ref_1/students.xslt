					...
					<div class="container container-student">
						...
						<div class="row">
							...
							<div class="six columns">
								Student ID: <xsl:value-of select="personaldetails/id" />
								<br />
								Other Title: <xsl:value-of select="personaldetails/id" />
								<br />
								Some Other Value: <xsl:value-of select="personaldetails/id" />
								<br />
								FInally SOme more: <xsl:value-of select="personaldetails/id" />
							</div>
